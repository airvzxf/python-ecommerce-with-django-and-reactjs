...
-- Fri 01 Mar 2019 01:16:21 AM CST
...
-- Schema python_ecommerce
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `python_ecommerce` ;
SHOW WARNINGS;
...
-- -----------------------------------------------------
-- Placeholder table for view `python_ecommerce`.`orders_by_customer_view`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `python_ecommerce`.`orders_by_customer_view` (`customer_id` INT, `sum_total` INT);
SHOW WARNINGS;
...
SELECT
    ...
    orders_by_customer_view.sum_total
FROM
    customer
LEFT JOIN
    orders_by_customer_view
    ON customer.id = orders_by_customer_view.customer_id
GROUP BY
    customer.id
ORDER BY
    customer.last_name,
...
-- -----------------------------------------------------
-- View `python_ecommerce`.`orders_by_customer_view`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `python_ecommerce`.`orders_by_customer_view`;
SHOW WARNINGS;
DROP VIEW IF EXISTS `python_ecommerce`.`orders_by_customer_view` ;
SHOW WARNINGS;
USE `python_ecommerce`;
CREATE  OR REPLACE VIEW `orders_by_customer_view` AS
SELECT
    orders.customer_id,
...
START TRANSACTION;
USE `python_ecommerce`;
INSERT INTO `python_ecommerce`.`orders` (`id`, `customer_id`, `date`, `total`) VALUES (1, 1, '2018-03-01 10:32:46.336148', 200.00);
INSERT INTO `python_ecommerce`.`orders` (`id`, `customer_id`, `date`, `total`) VALUES (2, 3, '2018-08-02 08:53:14.395756', 182.00);
INSERT INTO `python_ecommerce`.`orders` (`id`, `customer_id`, `date`, `total`) VALUES (3, 2, '2018-11-24 21:38:51.873928', 3000.00);
INSERT INTO `python_ecommerce`.`orders` (`id`, `customer_id`, `date`, `total`) VALUES (4, 1, '2019-04-13 16:26:19.786383', 110.00);
INSERT INTO `python_ecommerce`.`orders` (`id`, `customer_id`, `date`, `total`) VALUES (5, 4, '2019-01-21 00:18:40.982738', 388.74);
